...
static uint32_t extract(const unsigned char *s, int start, int length)
{
...
static char *btoe(char *store, const unsigned char *c)
{
...
const char *skey_response(int sequence, const char *seed, const char *pass)
{
// TODO: Remove this ifdef!
#if 0
